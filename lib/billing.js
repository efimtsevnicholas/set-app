export const DEFAULT_PLANS = Object.freeze([
  { code: 'pro_monthly', name: 'SET Monthly', interval: 'month', amountCents: 999, currency: 'EUR', trialDays: 3 },
  { code: 'pro_yearly', name: 'SET Yearly', interval: 'year', amountCents: 9999, currency: 'EUR', trialDays: 3 },
  { code: 'pro_3year', name: 'SET 3 Years', interval: 'year', intervalCount: 3, amountCents: 26900, currency: 'EUR', trialDays: 3 },
]);
