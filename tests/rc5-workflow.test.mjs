...
test('calendar events remain editable movable deletable and typed',()=>{for(const x of ['openEditor','Edit event','Delete event','Commercial photo shoot','Commercial video','Casting'])assert.ok(app.includes(x),x)});
